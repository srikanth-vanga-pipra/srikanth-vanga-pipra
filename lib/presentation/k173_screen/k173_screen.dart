import 'notifier/k173_notifier.dart';
...
class K173Screen extends ConsumerStatefulWidget {
  const K173Screen({Key? key})
      : super(
          key: key,
        );

  @override
  K173ScreenState createState() => K173ScreenState();
}

class K173ScreenState extends ConsumerState<K173Screen> {
  @override
