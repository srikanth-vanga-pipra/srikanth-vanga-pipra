import 'notifier/twentysix_notifier.dart';
...
class TwentysixScreen extends ConsumerStatefulWidget {
  const TwentysixScreen({Key? key})
      : super(
          key: key,
        );

  @override
  TwentysixScreenState createState() => TwentysixScreenState();
}

class TwentysixScreenState extends ConsumerState<TwentysixScreen> {
  @override
