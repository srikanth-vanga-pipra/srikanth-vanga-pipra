import 'notifier/mainmap_notifier.dart';import 'package:flutter/material.dart';import 'package:tissue_culture/core/app_export.dart';import 'package:tissue_culture/presentation/defaultmap_page/defaultmap_page.dart';import 'package:tissue_culture/presentation/filed_homescreen_container_page/filed_homescreen_container_page.dart';import 'package:tissue_culture/presentation/k120_page/k120_page.dart';import 'package:tissue_culture/presentation/k45_page/k45_page.dart';import 'package:tissue_culture/widgets/app_bar/appbar_leading_image.dart';import 'package:tissue_culture/widgets/app_bar/appbar_subtitle.dart';import 'package:tissue_culture/widgets/app_bar/custom_app_bar.dart';import 'package:tissue_culture/widgets/custom_bottom_bar.dart';class MainmapScreen extends ConsumerStatefulWidget {const MainmapScreen({Key? key}) : super(key: key);

@override MainmapScreenState createState() =>  MainmapScreenState();

 }

// ignore_for_file: must_be_immutable
class MainmapScreenState extends ConsumerState<MainmapScreen> {GlobalKey<NavigatorState> navigatorKey = GlobalKey();

@override Widget build(BuildContext context) { return SafeArea(child: Scaffold(backgroundColor: theme.colorScheme.onErrorContainer.withOpacity(1), appBar: _buildAppBar(context), body: Container(width: double.maxFinite, padding: EdgeInsets.symmetric(vertical: 24.v), child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [Padding(padding: EdgeInsets.only(left: 24.h), child: Row(children: [CustomImageView(imagePath: ImageConstant.imgGroup1000001989, height: 48.adaptSize, width: 48.adaptSize), Padding(padding: EdgeInsets.only(left: 4.h, top: 12.v, bottom: 10.v), child: Text("msg_select_your_own".tr, style: CustomTextStyles.bodyLargePrimaryContainer))])), SizedBox(height: 26.v), Divider(color: appTheme.gray600), SizedBox(height: 22.v), Padding(padding: EdgeInsets.only(left: 24.h), child: Text("lbl_downloaded_maps".tr, style: theme.textTheme.titleSmall)), SizedBox(height: 20.v), _buildMainMapFrame(context), SizedBox(height: 20.v)])), bottomNavigationBar: _buildBottomBar(context))); } 
/// Section Widget
...
/// Navigates to the mapMenuScreen when the action is triggered.
onTapImgImage(BuildContext context) { NavigatorService.pushNamed(AppRoutes.mapMenuScreen, ); } 
 }
