import 'notifier/k147_notifier.dart';
...
class K147Screen extends ConsumerStatefulWidget {
  const K147Screen({Key? key})
      : super(
          key: key,
        );

  @override
  K147ScreenState createState() => K147ScreenState();
}

class K147ScreenState extends ConsumerState<K147Screen> {
  @override
