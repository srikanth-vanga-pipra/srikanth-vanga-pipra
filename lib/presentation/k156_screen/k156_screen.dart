import 'notifier/k156_notifier.dart';
...
class K156Screen extends ConsumerStatefulWidget {
  const K156Screen({Key? key})
      : super(
          key: key,
        );

  @override
  K156ScreenState createState() => K156ScreenState();
}

class K156ScreenState extends ConsumerState<K156Screen> {
  @override
