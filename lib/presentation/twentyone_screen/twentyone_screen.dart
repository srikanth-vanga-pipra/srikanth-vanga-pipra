...
/// Section Widget
Widget _buildTitle(BuildContext context) { return Consumer(builder: (context, ref, _) {return CustomTextFormField(controller: ref.watch(twentyoneNotifier).titleController, hintText: "msg_enter_plant_height".tr);}); } 
/// Section Widget
Widget _buildTitle1(BuildContext context) { return Consumer(builder: (context, ref, _) {return CustomTextFormField(controller: ref.watch(twentyoneNotifier).titleController1, hintText: "msg_enter_the_stature".tr);}); } 
/// Section Widget
Widget _buildTitle2(BuildContext context) { return Consumer(builder: (context, ref, _) {return CustomTextFormField(controller: ref.watch(twentyoneNotifier).titleController2, hintText: "msg_enter_the_no_of".tr);}); } 
/// Section Widget
Widget _buildTitle3(BuildContext context) { return Consumer(builder: (context, ref, _) {return CustomTextFormField(controller: ref.watch(twentyoneNotifier).titleController3, hintText: "msg_enter_the_expected".tr);}); } 
/// Section Widget
Widget _buildTitle4(BuildContext context) { return Consumer(builder: (context, ref, _) {return CustomTextFormField(controller: ref.watch(twentyoneNotifier).titleController4, hintText: "msg_enter_the_weight_kg".tr);}); } 
/// Section Widget
Widget _buildTitle5(BuildContext context) { return Consumer(builder: (context, ref, _) {return CustomTextFormField(controller: ref.watch(twentyoneNotifier).titleController5, hintText: "msg_enter_the_no_of2".tr, textInputAction: TextInputAction.done);}); } 
/// Section Widget
...
/// Navigates to the twentyScreen when the action is triggered.
onTapArrowDown(BuildContext context) { NavigatorService.pushNamed(AppRoutes.twentyScreen, ); } 
/// Navigates to the twentytwoScreen when the action is triggered.
onTapContinue(BuildContext context) { NavigatorService.pushNamed(AppRoutes.twentytwoScreen, ); } 
 }
