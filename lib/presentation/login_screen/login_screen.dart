...
import 'package:tissue_culture/widgets/custom_checkbox_button.dart';
        ...
        Consumer(
          builder: (context, ref, _) {
            return CustomTextFormField(
              controller: ref.watch(loginNotifier).enterUserIdController,
            ...
            return CustomTextFormField(
              ...
              suffix: InkWell(
                ...
                child: Container(
                  ...
                  child: CustomImageView(
                    imagePath: ImageConstant.imgEyeclose,
                    height: 24.adaptSize,
                    width: 24.adaptSize,
                  ),
                ),
