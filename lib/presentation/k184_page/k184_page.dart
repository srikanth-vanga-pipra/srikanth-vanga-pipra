import '../k184_page/widgets/frame7_item_widget.dart';
import 'models/frame7_item_model.dart';
import 'notifier/k184_notifier.dart';
...
class K184Page extends ConsumerStatefulWidget {
  const K184Page({Key? key})
      : super(
          key: key,
        );

  @override
  K184PageState createState() => K184PageState();
}

class K184PageState extends ConsumerState<K184Page>
    with AutomaticKeepAliveClientMixin<K184Page> {
  @override
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildColumnSuckerCollectionReport(context),
                    ],
                  ),
                ),
              ],
  ...
  /// Section Widget
  Widget _buildColumnSuckerCollectionReport(BuildContext context) {
    return Container(
                ...
                children: [
                  ...
                  Align(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          "msg_discard_label_report".tr,
                          style: CustomTextStyles
                              .titleSmallPlusJakartaSansGray90003,
                        ),
