...
/// Navigates to the ten3Screen when the action is triggered.
onTapArrowDown(BuildContext context) { NavigatorService.pushNamed(AppRoutes.ten3Screen, ); } 
/// Navigates to the twelve2Screen when the action is triggered.
onTapGenerateQRCode(BuildContext context) { NavigatorService.pushNamed(AppRoutes.twelve2Screen, ); } 
 }
