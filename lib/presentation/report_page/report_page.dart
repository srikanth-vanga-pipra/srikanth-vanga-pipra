import '../report_page/widgets/frame4_item_widget.dart';
...
class ReportPageState extends ConsumerState<ReportPage>
  ...
  /// Section Widget
  Widget _buildColumn48(BuildContext context) {
    return Container(
                          ...
                          builder: (context, ref, _) {
                            return Wrap(
                              ...
                              children: List<Widget>.generate(
                                ref
                                        .watch(reportNotifier)
                                        .reportModelObj
                                        ?.frame4ItemList
                                        .length ??
                                    0,
                                (index) {
                                  Frame4ItemModel model = ref
                                          .watch(reportNotifier)
                                          .reportModelObj
                                          ?.frame4ItemList[index] ??
                                      Frame4ItemModel();
