...
onTapArrowDown(BuildContext context) { NavigatorService.pushNamed(AppRoutes.fourteenScreen, ); } 
/// Navigates to the fourteenScreen when the action is triggered.
onTapImgImage(BuildContext context) { NavigatorService.pushNamed(AppRoutes.fourteenScreen, ); } 
/// Navigates to the sixteenScreen when the action is triggered.
onTapImgImage1(BuildContext context) { NavigatorService.pushNamed(AppRoutes.sixteenScreen, ); } 
/// Navigates to the seventeenScreen when the action is triggered.
onTapContinueButton(BuildContext context) { NavigatorService.pushNamed(AppRoutes.seventeenScreen, ); } 
 }
