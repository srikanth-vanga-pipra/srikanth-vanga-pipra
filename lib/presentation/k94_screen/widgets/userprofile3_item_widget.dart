...
class Userprofile3ItemWidget extends StatelessWidget {
  ...
  VoidCallback? onTapViewDetailsButton;
                          ...
                          child: Row(
                            ...
                            children: [
                              Padding(
                                ...
                                child: Text(
                                  userprofile3ItemModelObj.tagNumberText!,
                              ...
                              Padding(
                                padding: EdgeInsets.only(top: 1.v),
                                child: Text(
                                  userprofile3ItemModelObj.colonText!,
                                  style: CustomTextStyles.labelLargeGray900,
                                ),
                              ),
                              Text(
                                userprofile3ItemModelObj.numberText!,
                      ...
                      Align(
                        ...
                        child: Container(
                          ...
                          child: Row(
                            children: [
                              Text(
                                userprofile3ItemModelObj.varietyText!,
                                style: CustomTextStyles.bodySmallGray900,
                              ),
                              Spacer(),
                              Text(
                                userprofile3ItemModelObj.colonText1!,
                                style: CustomTextStyles.labelLargeGray900,
                              ),
                              Padding(
                                padding: EdgeInsets.only(left: 4.h),
                                child: Text(
                                  userprofile3ItemModelObj.sevenText!,
                                  style: theme.textTheme.labelLarge,
                                ),
                              ),
                            ],
                      ...
                      Align(
                        ...
                        child: Container(
                          ...
                          child: Row(
                            children: [
                              Text(
                                userprofile3ItemModelObj.speciesText!,
                                style: CustomTextStyles.bodySmallGray900,
                              ),
                              Spacer(),
                              Text(
                                userprofile3ItemModelObj.colonText2!,
                                style: CustomTextStyles.labelLargeGray900,
                              ),
                              Padding(
                                padding: EdgeInsets.only(left: 4.h),
                                child: Text(
                                  userprofile3ItemModelObj.twoText!,
                                  style: theme.textTheme.labelLarge,
                                ),
                              ),
                            ],
