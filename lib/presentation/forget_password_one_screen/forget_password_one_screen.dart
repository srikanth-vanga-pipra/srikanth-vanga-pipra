import 'notifier/forget_password_one_notifier.dart';import 'package:flutter/material.dart';import 'package:tissue_culture/core/app_export.dart';import 'package:tissue_culture/widgets/app_bar/appbar_leading_image.dart';import 'package:tissue_culture/widgets/app_bar/appbar_subtitle_two.dart';import 'package:tissue_culture/widgets/app_bar/custom_app_bar.dart';class ForgetPasswordOneScreen extends ConsumerStatefulWidget {const ForgetPasswordOneScreen({Key? key}) : super(key: key);

@override ForgetPasswordOneScreenState createState() =>  ForgetPasswordOneScreenState();

 }
class ForgetPasswordOneScreenState extends ConsumerState<ForgetPasswordOneScreen> {@override Widget build(BuildContext context) { return SafeArea(child: Scaffold(appBar: _buildAppBar(context), body: Container(width: double.maxFinite, padding: EdgeInsets.symmetric(horizontal: 23.h, vertical: 32.v), child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [Container(width: 295.h, margin: EdgeInsets.only(right: 16.h), child: Text("msg_please_contact_to".tr, maxLines: 2, overflow: TextOverflow.ellipsis, style: CustomTextStyles.titleSmallGray70001.copyWith(height: 1.71))), Spacer(flex: 32), CustomImageView(imagePath: ImageConstant.imgGroup, height: 132.v, width: 110.h, alignment: Alignment.center), Spacer(flex: 67)])))); } 
/// Section Widget
...
onTapArrowDown(BuildContext context) { NavigatorService.pushNamed(AppRoutes.logintwoScreen, ); } 
 }
